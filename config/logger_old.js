...
var winston = require('winston'),
    fs = require('fs'),
    logDir = 'IconLogs/', // Or read from a configuration
...
var filename = logDir + 'logs/logs_' + Pad("0", parseInt(new Date().getDate()), 2) + '_' + Pad("0", parseInt(new Date().getMonth() + 1), 2) + '_' + new Date().getFullYear() + '.log';
